...
from tcavvideo.cav import CAV
from tcavvideo.cav import get_or_train_cav
from tcavvideo import run_params
...
class TCAV(object):
  ...
  """
    ...
    """
        ...
        # Get acts
        # ---get acts for one pair [object, concept, random]
